    ...
    <div className={`min-h-screen ${isDark ? 'bg-neutral-900' : 'bg-neutral-50'} flex flex-col items-center justify-center p-4`}>
      <div className="max-w-3xl w-full">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h1 className={`text-2xl sm:text-3xl font-medium ${isDark ? 'text-white' : 'text-neutral-900'}`}>Ready to join?</h1>
        </div>
        ...
        <div className="flex justify-center gap-3 sm:gap-4">
          <button
            onClick={() => navigate(-1)}
            className={`px-6 py-3 ${isDark ? 'bg-neutral-800 border-neutral-700 text-white hover:bg-neutral-700' : 'bg-white border-neutral-300 text-neutral-900 hover:bg-neutral-50'} border rounded-lg font-medium transition-all shadow-soft`}
          >
            Cancel
          </button>
          <button
            ...
            className={`px-6 py-3 ${isDark ? 'bg-white hover:bg-neutral-200 text-black' : 'bg-black hover:bg-neutral-800 text-white'} disabled:opacity-50 disabled:cursor-not-allowed rounded-lg font-medium transition-all shadow-md-soft`}
          >
            Join now
          </button>
        </div>
